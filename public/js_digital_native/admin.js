            ...
            },
            {
                ...
                "data": function (data,) {
                    return '<div class="dropdown">'
                        ...
                        + '<li><a style="cursor: pointer;" data-id="' + data[0] + '" onclick="cancelReport(this)">Batalkan</a></li>'
                        + '</ul>'
                        + '</div>'
                        + '</div>'
                }
            ...
            },
            {
                ...
                "data": function (data,) {
                    return '<div class="dropdown">'
                        ...
                        + '<li><a style="cursor: pointer;" data-id="' + data[0] + '" onclick="showReplyTable(this)">Tindak Lanjut</a></li>'
                        + '</ul>'
                        + '</div>'
                        + '</div>'
                }
