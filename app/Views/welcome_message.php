...
<head>
    <base href=".<?php echo base_url() ?>/public/landing/src/">
    <meta charset="utf-8">
    <meta name="author" content="Softnio">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="A powerful and conceptual apps base dashboard template that especially build for developers and programmers.">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="<?php echo base_url() ?>/public/landing/src/images/favicon.png">
    <!-- Page Title  -->
    <title><?php echo $title ?></title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="<?php echo base_url() ?>/public/landing/src/assets/css/dashlite.css?ver=3.2.3">
    <link id="skin-default" rel="stylesheet" href="<?php echo base_url() ?>/public/landing/src/assets/css/theme.css?ver=3.2.3">
</head>
...
<body class="nk-body bg-white npc-landing ">
                        ...
                        <div class="header-wrap">
                            <div class="header-logo">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img" src="<?php echo base_url() ?>/public/landing/src/images/logo.png" srcset="<?php echo base_url() ?>/public/landing/src/images/logo2x.png 2x" alt="logo">
                                    <img class="logo-dark logo-img" src="<?php echo base_url() ?>/public/landing/src/images/logo-dark.png" srcset="<?php echo base_url() ?>/public/landing/src/images/logo-dark2x.png 2x" alt="logo-dark">
                                </a>
                            </div>
                            ...
                            <nav class="header-menu" data-content="mainNav">
                                <ul class="menu-list ms-lg-auto">
                                    ...
                                    <li class="menu-item"><a href="#reviews" class="menu-link nav-link">Kebijakan Privasi</a></li>
                                    <li class="menu-item"><a href="#reviews" class="menu-link nav-link">Layanan</a></li>
                                    <li class="menu-item"><a href="#reviews" class="menu-link nav-link">Tentang</a></li>
                                </ul>
                                <ul class="menu-btns">
                                    <li>
                                        <a href="https://1.envato.market/e0y3g" target="_blank" class="btn btn-primary btn-lg">Login</a>
                                    </li>
                                </ul>
                            </nav><!-- .nk-nav-menu -->
                        </div><!-- .header-warp-->
                    ...
                    <div class="container">
                                ...
                                <div id="carouselExConInd" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo base_url() ?>/public/landing/src/images/slides/slide-a.jpg" class="d-block w-100" alt="carousel">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url() ?>/public/landing/src/images/slides/slide-b.jpg" class="d-block w-100" alt="carousel">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo base_url() ?>/public/landing/src/images/slides/slide-c.jpg" class="d-block w-100" alt="carousel">
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-5 col-md-10">
                            <div class="header-caption">
                                ...
                                <h1 class="title">SIKON</h1>
                                <h3 class="title">Sistem Informasi Pelaporan Konflik Sosial<br> Kabupaten Barito Timur</h3>
                                <div class="header-text">
                                    <p>Laporkan secara online konflik Sosial </p>
                                </div>
                                <ul class="header-action btns-inline">
                                    <li><a href="<?= base_url()?>register" class="btn btn-primary btn-lg"><span>Daftar</span></a></li>
                                    <li><a href="#" class="link link-block link-gray"><em class="icon icon-lg ni ni-play-circle"></em><span>Tutorial Video</span></a></li>
                                </ul>
                            </div><!-- .header-caption -->
                        </div><!-- .col -->
                    </div><!-- .row -->
                ...
                <div class="row align-items-center g-gs">
                    <div class="col-4 col-md-2">
                        <div class="brand-item">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/brand/brand-a.png" alt="">
                        </div>
                    </div><!-- .col -->
                    <div class="col-4 col-md-2">
                        <div class="brand-item">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/brand/brand-b.png" alt="">
                        </div>
                    </div><!-- .col -->
                    <div class="col-4 col-md-2">
                        <div class="brand-item">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/brand/brand-c.png" alt="">
                        </div>
                    </div><!-- .col -->
                    <div class="col-4 col-md-2">
                        <div class="brand-item">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/brand/brand-d.png" alt="">
                        </div>
                    </div><!-- .col -->
                    <div class="col-4 col-md-2">
                        <div class="brand-item">
                ...
                <div class="row align-items-center justify-content-lg-between g-gs">
                    <div class="col-lg-5">
                        <div class="img-block img-block-s1 left">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/gfx/a.png" alt="img">
                        </div><!-- .img-block -->
                    </div><!-- .col -->
                    <div class="col-lg-6">
                ...
                <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                    <div class="col-lg-5">
                        <div class="img-block img-block-s1 right">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/gfx/b.png" alt="img">
                        </div><!-- .img-block -->
                    </div><!-- .col -->
                    <div class="col-lg-6">
        ...
        <section class="section section-feature">
            <div class="container">
                <div class="row align-items-center justify-content-between g-gs">
                    <div class="col-lg-5">
                        <div class="img-block img-block-s1 left">
                            <img src="<?php echo base_url() ?>/public/landing/src/images/gfx/c.png" alt="img">
                        </div>
                    </div><!-- .col -->
                    <div class="col-lg-6">
                        <div class="text-block">
                                ...
                                <div class="review review-s2">
                                    <div class="review-portrait review-portrait-s1">
                                        <div class="portrait portrait-s1">
                                            <img src="<?php echo base_url() ?>/public/landing/src/images/client/client-a.png" alt="">
                                        </div>
                                    </div>
                                    <div class="review-content">
                                        <div class="review-rating rating rating-sm">
                        ...
                        <div class="card card-shadow round-xl">
                            <div class="card-inner card-inner-lg">
                                <div class="review review-s2">
                                    <div class="review-portrait review-portrait-s1">
                                        <div class="portrait portrait-s1">
                                            <img src="<?php echo base_url() ?>/public/landing/src/images/client/client-b.png" alt="">
                                        </div>
                                    </div>
                                    <div class="review-content">
                                        <div class="review-rating rating rating-sm">
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="<?php echo base_url() ?>/public/landing/src/assets/js/bundle.js?ver=3.2.3"></script>
    <script src="<?php echo base_url() ?>/public/landing/src/assets/js/scripts.js?ver=3.2.3"></script>
</body>
